...
{
    public partial class PaperPayReport : Form
    {
        public PaperPayReport()
        {
            InitializeComponent();
            try
            {
        ...
        private void getReportId()
        {
            ...
            PaperPayControllar.paper_payDataTable mcdt = prta.GetData();
            cbIds.Items.Clear();
        ...
        private void getReport(Guid id)
        {
            try
            {
                // TODO: This line of code loads data into the 'paperPayDataSet.PaperPayData' table. You can move, or remove it, as needed.
                this.paperPayDataTableAdapter.Fill(this.paperPayDataSet.PaperPayData,id);
