...
namespace Program.entityForm.Supplier.Report
{
    public partial class PayCheck : Form
    {
        ...
        {
            bank_creditTableAdapter mcta = new bank_creditTableAdapter();
            BankControllar.bank_creditDataTable mcdt = mcta.GetData();
            cbIds.Items.Clear();
        ...
        private void getReport(int id)
        {
            try
            {
                ...
                this.bank_creditPayCheckTableAdapter.Fill(this.bankDataSet.bank_creditPayCheck,id);
